...
HltGsfTrkAnalyser::HltGsfTrkAnalyser(const edm::ParameterSet& iConfig)
{
   ...
   //
   hMatch_diff_p = fs->make<TH1D>("hMatch_diff_p", "GsfTrack_{matched}: p_{test} - p_{ref}", 100, -1., 1.);
   hMatch_diff_pt = fs->make<TH1D>("hMatch_diff_pt", "GsfTrack_{matched}: p_{T}^{test} - p_{T}^{ref}", 100, -1., 1.);
   hMatch_diff_eta = fs->make<TH1D>("hMatch_diff_eta", "GsfTrack_{matched}: #eta_{test} -  #eta_{ref}", 100, -0.0001, 0.0002);
   hMatch_diff_phi = fs->make<TH1D>("hMatch_diff_phi", "GsfTrack_{matched}: #phi_{test} - #phi_{ref}", 100, -0.0005, 0.0005);
   hMatch_diff_ptError = fs->make<TH1D>("hMatch_diff_ptError", "GsfTrack_{matched}: p_{T}-error_{test} - p_{T}-error_{ref}", 100, -0.3, 0.3);
   hMatch_diff_dPtOverPt = fs->make<TH1D>("hMatch_diff_dPtOverPt", "GsfTrack_{matched}: dp_{T}/p_{T}^{test} - dp_{T}/p_{T}^{ref}", 100, -0.03, 0.03);
   hMatch_diff_etaError = fs->make<TH1D>("hMatch_diff_etaError", "GsfTrack_{matched}: #eta-error_{test} - #eta-error_{ref}", 100, -0.00003, 0.00005);
   hMatch_diff_phiError = fs->make<TH1D>("hMatch_diff_phiError", "GsfTrack_{matched}: #phi-error_{test} - #phi-error_{ref}", 100, -0.0002, 0.0002);
   hMatch_diff_outerP = fs->make<TH1D>("hMatch_diff_outerP", "GsfTrack_{matched}: p_{out}^{test} - p_{out}^{ref}", 100, -1., 1.);
   hMatch_diff_outerPt = fs->make<TH1D>("hMatch_diff_outerPt", "GsfTrack_{matched}: (p_{T}^{out})_{test} - (p_{T}^{out})_{ref}", 100, -1., 1.);
   hMatch_diff_outerEta = fs->make<TH1D>("hMatch_diff_outerEta", "GsfTrack_{matched}: #eta_{out}^{test} - #eta_{out}^{ref}", 100, -0.0001, 0.0002);
   hMatch_diff_outerPhi = fs->make<TH1D>("hMatch_diff_outerPhi", "GsfTrack_{matched}: #phi_{out}^{test} - #phi_{out}^{ref}", 100, -0.0005, 0.0005);
   hMatch_diff_outerPOverP = fs->make<TH1D>("hMatch_diff_outerPOverP", "GsfTrack_{matched}: (p_{out}/p)_{test} - (p_{out}/p)_{ref}", 100, -0.05, 0.05);
   hMatch_diff_outerPtOverPt = fs->make<TH1D>("hMatch_diff_outerPtOverPt", "GsfTrack_{matched}: (p_{T}^{out}/p_{T})_{test} - (p_{T}^{out}/p_{T})_{ref}", 100, -0.05, 0.05);
   //
   //hMatch_diff_p = fs->make<TH1D>("hMatch_diff_p", "GsfTrack_{matched}: p_{test} - p_{ref}", 100, -2., 2.);
   //hMatch_diff_pt = fs->make<TH1D>("hMatch_diff_pt", "GsfTrack_{matched}: p_{T}^{test} - p_{T}^{ref}", 100, -2., 2.);
   //hMatch_diff_eta = fs->make<TH1D>("hMatch_diff_eta", "GsfTrack_{matched}: #eta_{test} -  #eta_{ref}", 100, -0.001, 0.001);
   //hMatch_diff_phi = fs->make<TH1D>("hMatch_diff_phi", "GsfTrack_{matched}: #phi_{test} - #phi_{ref}", 100, -0.001, 0.001);
   //hMatch_diff_ptError = fs->make<TH1D>("hMatch_diff_ptError", "GsfTrack_{matched}: p_{T}-error_{test} - p_{T}-error_{ref}", 100, -1., 1.);
   //hMatch_diff_dPtOverPt = fs->make<TH1D>("hMatch_diff_dPtOverPt", "GsfTrack_{matched}: dp_{T}/p_{T}^{test} - dp_{T}/p_{T}^{ref}", 100, -0.075, 0.075);
   //hMatch_diff_etaError = fs->make<TH1D>("hMatch_diff_etaError", "GsfTrack_{matched}: #eta-error_{test} - #eta-error_{ref}", 100, -0.0002, 0.0002);
   //hMatch_diff_phiError = fs->make<TH1D>("hMatch_diff_phiError", "GsfTrack_{matched}: #phi-error_{test} - #phi-error_{ref}", 100, -0.0005, 0.0005);
   //hMatch_diff_outerP = fs->make<TH1D>("hMatch_diff_outerP", "GsfTrack_{matched}: p_{out}^{test} - p_{out}^{ref}", 100, -2., 2.);
   //hMatch_diff_outerPt = fs->make<TH1D>("hMatch_diff_outerPt", "GsfTrack_{matched}: (p_{T}^{out})_{test} - (p_{T}^{out})_{ref}", 100, -2., 2.);
   //hMatch_diff_outerEta = fs->make<TH1D>("hMatch_diff_outerEta", "GsfTrack_{matched}: #eta_{out}^{test} - #eta_{out}^{ref}", 100, -0.001, 0.001);
   //hMatch_diff_outerPhi = fs->make<TH1D>("hMatch_diff_outerPhi", "GsfTrack_{matched}: #phi_{out}^{test} - #phi_{out}^{ref}", 100, -0.001, 0.001);
   //hMatch_diff_outerPOverP = fs->make<TH1D>("hMatch_diff_outerPOverP", "GsfTrack_{matched}: (p_{out}/p)_{test} - (p_{out}/p)_{ref}", 100, -0.1, 0.1);
   //hMatch_diff_outerPtOverPt = fs->make<TH1D>("hMatch_diff_outerPtOverPt", "GsfTrack_{matched}: (p_{T}^{out}/p_{T})_{test} - (p_{T}^{out}/p_{T})_{ref}", 100, -0.1, 0.1);
   //
   ...
   // wide
   //hMatch_pull_p = fs->make<TH1D>("hMatch_pull_p", "GsfTrack_{matched}: (p_{test} - p_{ref})/p_{ref}", 100, -30., 30.);
   //hMatch_pull_pt = fs->make<TH1D>("hMatch_pull_pt", "GsfTrack_{matched}: (p_{T}^{test} - p_{T}^{ref})/p_{T}^{ref}", 100, -20., 20.)//;
   //hMatch_pull_eta = fs->make<TH1D>("hMatch_pull_eta", "GsfTrack_{matched}: (#eta_{test} -  #eta_{ref})/#eta_{ref}", 100, -1., 1.); //
   //hMatch_pull_ptError = fs->make<TH1D>("hMatch_pull_ptError", "GsfTrack_{matched}: (p_{T}-error_{test} - p_{T}-error_{ref})/p_{T}-e//rror_{ref}", 100, -20., 20.);
   //hMatch_pull_dPtOverPt = fs->make<TH1D>("hMatch_pull_dPtOverPt", "GsfTrack_{matched}: (dp_{T}/p_{T}^{test} - dp_{T}/p_{T}^{ref})/(//dp_{T}/p_{T}^{ref})", 100, -3., 3.);
   //hMatch_pull_etaError = fs->make<TH1D>("hMatch_pull_etaError", "GsfTrack_{matched}: (#eta-error_{test} - #eta-error_{ref})/#eta-er//ror_{ref}", 100, -3., 3.);
   //hMatch_pull_phiError = fs->make<TH1D>("hMatch_pull_phiError", "GsfTrack_{matched}: (#phi-error_{test} - #phi-error_{ref})/#phi-er//ror_{ref}", 100, -3., 3.);
   //hMatch_pull_outerP = fs->make<TH1D>("hMatch_pull_outerP", "GsfTrack_{matched}: (p_{out}^{test} - p_{out}^{ref})/p_{out}^{ref}", 1//00, -25., 25.);
   //hMatch_pull_outerPt = fs->make<TH1D>("hMatch_pull_outerPt", "GsfTrack_{matched}: ((p_{T}^{out})_{test} - (p_{T}^{out})_{ref})/(p_//{T}^{out})_{ref}", 100, -25., 25.);
   //hMatch_pull_outerEta = fs->make<TH1D>("hMatch_pull_outerEta", "GsfTrack_{matched}: (#eta_{out}^{test} - #eta_{out}^{ref})/#eta_{o//ut}^{ref}", 100, -1., 1.);
   //hMatch_pull_outerPOverP = fs->make<TH1D>("hMatch_pull_outerPOverP", "GsfTrack_{matched}: ((p_{out}/p)_{test} - (p_{out}/p)_{ref})///(p_{out}/p)_{ref}", 100, -8., 8.);
   //hMatch_pull_outerPtOverPt = fs->make<TH1D>("hMatch_pull_outerPtOverPt", "GsfTrack_{matched}: ((p_{T}^{out}/p_{T})_{test} - (p_{T}//^{out}/p_{T})_{ref})/(p_{T}^{out}/p_{T})_{ref}", 100, -8., 8.);
   //hMatch_pull_chi2 = fs->make<TH1D>("hMatch_pull_chi2", "GsfTrack_{matched}: (#chi^{2}_{test} - #chi^{2}_{ref})/#chi^{2}_{ref}", 10//0, -20., 20.);
   //hMatch_pull_ndof = fs->make<TH1D>("hMatch_pull_ndof", "GsfTrack_{matched}: (ndof_{test} - ndof_{ref})/ndof_{ref}", 100, -3., 3.);//
   //hMatch_pull_normalizedChi2 = fs->make<TH1D>("hMatch_pull_normalizedChi2", "GsfTrack_{matched}: ((#chi^{2}_{normalized})_{test} - //(#chi^{2}_{normalized})_{ref})/(#chi^{2}_{normalized})_{ref}", 100, -10., 10.);
   //hMatch_pull_dxy = fs->make<TH1D>("hMatch_pull_dxy", "GsfTrack_{matched}: (d_{xy}^{test} - d_{xy}^{ref})/d_{xy}^{ref}", 100, -10//., 10.);
   //hMatch_pull_dz = fs->make<TH1D>("hMatch_pull_dz", "GsfTrack_{matched}: (d_{z}^{test} - d_{z}^{ref})/d_{z}^{ref}", 100, -10., 10//.);
   //hMatch_pull_dxyError = fs->make<TH1D>("hMatch_pull_dxyError", "GsfTrack_{matched}: (d_{xy}-error_{test} - d_{xy}-error_{ref})/d_{//xy}-error_{ref}", 100, -4., 4.);
   //hMatch_pull_dzError = fs->make<TH1D>("hMatch_pull_dzError", "GsfTrack_{matched}: (d_{z}-error_{test} - d_{z}-error_{ref})/d_{z}-e//rror_{ref}", 100, -4., 4.);
   // narrow                                                                                                                          //
   hMatch_pull_p = fs->make<TH1D>("hMatch_pull_p", "GsfTrack_{matched}: (p_{test} - p_{ref})/p_{ref}", 100, -1.1, 1.1);
   hMatch_pull_pt = fs->make<TH1D>("hMatch_pull_pt", "GsfTrack_{matched}: (p_{T}^{test} - p_{T}^{ref})/p_{T}^{ref}", 100, -1.1, 1.1);
   hMatch_pull_eta = fs->make<TH1D>("hMatch_pull_eta", "GsfTrack_{matched}: (#eta_{test} -  #eta_{ref})/#eta_{ref}", 100, -0.02, 0.02);
   hMatch_pull_ptError = fs->make<TH1D>("hMatch_pull_ptError", "GsfTrack_{matched}: (p_{T}-error_{test} - p_{T}-error_{ref})/p_{T}-error_{ref}", 100, -1.1, 1.1);
   hMatch_pull_dPtOverPt = fs->make<TH1D>("hMatch_pull_dPtOverPt", "GsfTrack_{matched}: (dp_{T}/p_{T}^{test} - dp_{T}/p_{T}^{ref})/(dp_{T}/p_{T}^{ref})", 100, -1.1, 1.1);
   hMatch_pull_etaError = fs->make<TH1D>("hMatch_pull_etaError", "GsfTrack_{matched}: (#eta-error_{test} - #eta-error_{ref})/#eta-error_{ref}", 100, -1.1, 1.1);
   hMatch_pull_phiError = fs->make<TH1D>("hMatch_pull_phiError", "GsfTrack_{matched}: (#phi-error_{test} - #phi-error_{ref})/#phi-error_{ref}", 100, -1.1, 1.1);
   hMatch_pull_outerP = fs->make<TH1D>("hMatch_pull_outerP", "GsfTrack_{matched}: (p_{out}^{test} - p_{out}^{ref})/p_{out}^{ref}", 100, -1.1, 1.1);
   hMatch_pull_outerPt = fs->make<TH1D>("hMatch_pull_outerPt", "GsfTrack_{matched}: ((p_{T}^{out})_{test} - (p_{T}^{out})_{ref})/(p_{T}^{out})_{ref}", 100, -1.1, 1.1);
   hMatch_pull_outerEta = fs->make<TH1D>("hMatch_pull_outerEta", "GsfTrack_{matched}: (#eta_{out}^{test} - #eta_{out}^{ref})/#eta_{out}^{ref}", 100, -0.05, 0.05);
   hMatch_pull_outerPOverP = fs->make<TH1D>("hMatch_pull_outerPOverP", "GsfTrack_{matched}: ((p_{out}/p)_{test} - (p_{out}/p)_{ref})/(p_{out}/p)_{ref}", 100, -1.1, 1.1);
   hMatch_pull_outerPtOverPt = fs->make<TH1D>("hMatch_pull_outerPtOverPt", "GsfTrack_{matched}: ((p_{T}^{out}/p_{T})_{test} - (p_{T}^{out}/p_{T})_{ref})/(p_{T}^{out}/p_{T})_{ref}", 100, -1.1, 1.1);
   hMatch_pull_chi2 = fs->make<TH1D>("hMatch_pull_chi2", "GsfTrack_{matched}: (#chi^{2}_{test} - #chi^{2}_{ref})/#chi^{2}_{ref}", 100, -1.1, 1.1);
   hMatch_pull_ndof = fs->make<TH1D>("hMatch_pull_ndof", "GsfTrack_{matched}: (ndof_{test} - ndof_{ref})/ndof_{ref}", 100, -1.1, 1.1);
   hMatch_pull_normalizedChi2 = fs->make<TH1D>("hMatch_pull_normalizedChi2", "GsfTrack_{matched}: ((#chi^{2}_{normalized})_{test} - (#chi^{2}_{normalized})_{ref})/(#chi^{2}_{normalized})_{ref}", 100, -1.1, 1.1);
   hMatch_pull_dxy = fs->make<TH1D>("hMatch_pull_dxy", "GsfTrack_{matched}: (d_{xy}^{test} - d_{xy}^{ref})/d_{xy}^{ref}", 100, -1.1, 1.1);
   hMatch_pull_dz = fs->make<TH1D>("hMatch_pull_dz", "GsfTrack_{matched}: (d_{z}^{test} - d_{z}^{ref})/d_{z}^{ref}", 100, -1.1, 1.1);
   hMatch_pull_dxyError = fs->make<TH1D>("hMatch_pull_dxyError", "GsfTrack_{matched}: (d_{xy}-error_{test} - d_{xy}-error_{ref})/d_{xy}-error_{ref}", 100, -1.1, 1.1);
   hMatch_pull_dzError = fs->make<TH1D>("hMatch_pull_dzError", "GsfTrack_{matched}: (d_{z}-error_{test} - d_{z}-error_{ref})/d_{z}-error_{ref}", 100, -1.1, 1.1);
   // very narrow
   //hMatch_pull_p = fs->make<TH1D>("hMatch_pull_p", "GsfTrack_{matched}: (p_{test} - p_{ref})/p_{ref}", 100, -0.2, 0.2);
   //hMatch_pull_pt = fs->make<TH1D>("hMatch_pull_pt", "GsfTrack_{matched}: (p_{T}^{test} - p_{T}^{ref})/p_{T}^{ref}", 100, -0.2, 0.2);
   //hMatch_pull_eta = fs->make<TH1D>("hMatch_pull_eta", "GsfTrack_{matched}: (#eta_{test} -  #eta_{ref})/#eta_{ref}", 100, -0.001, 0.001);
   //hMatch_pull_ptError = fs->make<TH1D>("hMatch_pull_ptError", "GsfTrack_{matched}: (p_{T}-error_{test} - p_{T}-error_{ref})/p_{T}-error_{ref}", 100, -0.5, 0.5);
   //hMatch_pull_dPtOverPt = fs->make<TH1D>("hMatch_pull_dPtOverPt", "GsfTrack_{matched}: (dp_{T}/p_{T}^{test} - dp_{T}/p_{T}^{ref})/(dp_{T}/p_{T}^{ref})", 100, -0.5, 0.5);
   //hMatch_pull_etaError = fs->make<TH1D>("hMatch_pull_etaError", "GsfTrack_{matched}: (#eta-error_{test} - #eta-error_{ref})/#eta-error_{ref}", 100, -0.2, 0.2);
   //hMatch_pull_phiError = fs->make<TH1D>("hMatch_pull_phiError", "GsfTrack_{matched}: (#phi-error_{test} - #phi-error_{ref})/#phi-error_{ref}", 100, -0.5, 0.5);
   //hMatch_pull_outerP = fs->make<TH1D>("hMatch_pull_outerP", "GsfTrack_{matched}: (p_{out}^{test} - p_{out}^{ref})/p_{out}^{ref}", 100, -0.2, 0.2);
   //hMatch_pull_outerPt = fs->make<TH1D>("hMatch_pull_outerPt", "GsfTrack_{matched}: ((p_{T}^{out})_{test} - (p_{T}^{out})_{ref})/(p_{T}^{out})_{ref}", 100, -0.2, 0.2);
   //hMatch_pull_outerEta = fs->make<TH1D>("hMatch_pull_outerEta", "GsfTrack_{matched}: (#eta_{out}^{test} - #eta_{out}^{ref})/#eta_{out}^{ref}", 100, -0.002, 0.002);
   //hMatch_pull_outerPOverP = fs->make<TH1D>("hMatch_pull_outerPOverP", "GsfTrack_{matched}: ((p_{out}/p)_{test} - (p_{out}/p)_{ref})/(p_{out}/p)_{ref}", 100, -0.2, 0.2);
   //hMatch_pull_outerPtOverPt = fs->make<TH1D>("hMatch_pull_outerPtOverPt", "GsfTrack_{matched}: ((p_{T}^{out}/p_{T})_{test} - (p_{T}^{out}/p_{T})_{ref})/(p_{T}^{out}/p_{T})_{ref}", 100, -0.2, 0.2);
   //hMatch_pull_chi2 = fs->make<TH1D>("hMatch_pull_chi2", "GsfTrack_{matched}: (#chi^{2}_{test} - #chi^{2}_{ref})/#chi^{2}_{ref}", 100, -1.1, 1.1);
   //hMatch_pull_ndof = fs->make<TH1D>("hMatch_pull_ndof", "GsfTrack_{matched}: (ndof_{test} - ndof_{ref})/ndof_{ref}", 100, -1.1, 1.1);
   //hMatch_pull_normalizedChi2 = fs->make<TH1D>("hMatch_pull_normalizedChi2", "GsfTrack_{matched}: ((#chi^{2}_{normalized})_{test} - (#chi^{2}_{normalized})_{ref})/(#chi^{2}_{normalized})_{ref}", 100, -1.1, 1.1);
   //hMatch_pull_dxy = fs->make<TH1D>("hMatch_pull_dxy", "GsfTrack_{matched}: (d_{xy}^{test} - d_{xy}^{ref})/d_{xy}^{ref}", 100, -0.2, 0.2);
   //hMatch_pull_dz = fs->make<TH1D>("hMatch_pull_dz", "GsfTrack_{matched}: (d_{z}^{test} - d_{z}^{ref})/d_{z}^{ref}", 100, -0.05, 0.05);
   //hMatch_pull_dxyError = fs->make<TH1D>("hMatch_pull_dxyError", "GsfTrack_{matched}: (d_{xy}-error_{test} - d_{xy}-error_{ref})/d_{xy}-error_{ref}", 100, -1.1, 1.1);
   //hMatch_pull_dzError = fs->make<TH1D>("hMatch_pull_dzError", "GsfTrack_{matched}: (d_{z}-error_{test} - d_{z}-error_{ref})/d_{z}-error_{ref}", 100, -1.1, 1.1);
   //
   hMatch_pull_numberOfValidHits = fs->make<TH1D>("hMatch_pull_numberOfValidHits", "GsfTrack_{matched}: (#hits_{valid}^{test} - #hits_{valid}^{ref})/#hits_{valid}^{ref}", 40, -1., 3.);
   hMatch_pull_numberOfLostHits = fs->make<TH1D>("hMatch_pull_numberOfLostHits", "GsfTrack_{matched}: (#hits_{lost}^{test} - #hits_{lost}^{ref})/#hits_{lost}^{ref}", 10, -2.5, 2.5);
   hMatch_pull_validFraction = fs->make<TH1D>("hMatch_pull_validFraction", "GsfTrack_{matched}: (valid fraction_{test} - valid fraction_{ref})/valid fraction_{ref}", 100, -1., 1.);
   ...
   //hMatch_ptCut_pull_p = fs->make<TH1D>("hMatch_ptCut_pull_p", "GsfTrack_{matched}: (p_{test} - p_{ref})/p_{ref}", 100, -30., 30.);
   //hMatch_ptCut_pull_pt = fs->make<TH1D>("hMatch_ptCut_pull_pt", "GsfTrack_{matched}: (p_{T}^{test} - p_{T}^{ref})/p_{T}^{ref}", 100, -20., 20.);
   //hMatch_ptCut_pull_eta = fs->make<TH1D>("hMatch_ptCut_pull_eta", "GsfTrack_{matched}: (#eta_{test} -  #eta_{ref})/#eta_{ref}", 100, -1., 1.);
   //hMatch_ptCut_pull_ptError = fs->make<TH1D>("hMatch_ptCut_pull_ptError", "GsfTrack_{matched}: (p_{T}-error_{test} - p_{T}-error_{ref})/p_{T}-error_{ref}", 100, -20., 20.);
   //hMatch_ptCut_pull_dPtOverPt = fs->make<TH1D>("hMatch_ptCut_pull_dPtOverPt", "GsfTrack_{matched}: (dp_{T}/p_{T}^{test} - dp_{T}/p_{T}^{ref})/(dp_{T}/p_{T}^{ref})", 100, -3., 3.);
   //hMatch_ptCut_pull_etaError = fs->make<TH1D>("hMatch_ptCut_pull_etaError", "GsfTrack_{matched}: (#eta-error_{test} - #eta-error_{ref})/#eta-error_{ref}", 100, -3., 3.);
   //hMatch_ptCut_pull_phiError = fs->make<TH1D>("hMatch_ptCut_pull_phiError", "GsfTrack_{matched}: (#phi-error_{test} - #phi-error_{ref})/#phi-error_{ref}", 100, -3., 3.);
   //hMatch_ptCut_pull_outerP = fs->make<TH1D>("hMatch_ptCut_pull_outerP", "GsfTrack_{matched}: (p_{out}^{test} - p_{out}^{ref})/p_{out}^{ref}", 100, -25., 25.);
   //hMatch_ptCut_pull_outerPt = fs->make<TH1D>("hMatch_ptCut_pull_outerPt", "GsfTrack_{matched}: ((p_{T}^{out})_{test} - (p_{T}^{out})_{ref})/(p_{T}^{out})_{ref}", 100, -25., 25.);
   //hMatch_ptCut_pull_outerEta = fs->make<TH1D>("hMatch_ptCut_pull_outerEta", "GsfTrack_{matched}: (#eta_{out}^{test} - #eta_{out}^{ref})/#eta_{out}^{ref}", 100, -1., 1.);
   //hMatch_ptCut_pull_outerPOverP = fs->make<TH1D>("hMatch_ptCut_pull_outerPOverP", "GsfTrack_{matched}: ((p_{out}/p)_{test} - (p_{out}/p)_{ref})/(p_{out}/p)_{ref}", 100, -8., 8.);
   //hMatch_ptCut_pull_outerPtOverPt = fs->make<TH1D>("hMatch_ptCut_pull_outerPtOverPt", "GsfTrack_{matched}: ((p_{T}^{out}/p_{T})_{test} - (p_{T}^{out}/p_{T})_{ref})/(p_{T}^{out}/p_{T})_{ref}", 100, -8., 8.);
   //hMatch_ptCut_pull_chi2 = fs->make<TH1D>("hMatch_ptCut_pull_chi2", "GsfTrack_{matched}: (#chi^{2}_{test} - #chi^{2}_{ref})/#chi^{2}_{ref}", 100, -20., 20.);
   //hMatch_ptCut_pull_ndof = fs->make<TH1D>("hMatch_ptCut_pull_ndof", "GsfTrack_{matched}: (ndof_{test} - ndof_{ref})/ndof_{ref}", 100, -3., 3.);
   //hMatch_ptCut_pull_normalizedChi2 = fs->make<TH1D>("hMatch_ptCut_pull_normalizedChi2", "GsfTrack_{matched}: ((#chi^{2}_{normalized})_{test} - (#chi^{2}_{normalized})_{ref})/(#chi^{2}_{normalized})_{ref}", 100, -10., 10.);
   //hMatch_ptCut_pull_dxy = fs->make<TH1D>("hMatch_ptCut_pull_dxy", "GsfTrack_{matched}: (d_{xy}^{test} - d_{xy}^{ref})/d_{xy}^{ref}", 100, -10., 10.);
   //hMatch_ptCut_pull_dz = fs->make<TH1D>("hMatch_ptCut_pull_dz", "GsfTrack_{matched}: (d_{z}^{test} - d_{z}^{ref})/d_{z}^{ref}", 100, -10., 10.);
   //hMatch_ptCut_pull_dxyError = fs->make<TH1D>("hMatch_ptCut_pull_dxyError", "GsfTrack_{matched}: (d_{xy}-error_{test} - d_{xy}-error_{ref})/d_{xy}-error_{ref}", 100, -4., 4.);
   //hMatch_ptCut_pull_dzError = fs->make<TH1D>("hMatch_ptCut_pull_dzError", "GsfTrack_{matched}: (d_{z}-error_{test} - d_{z}-error_{ref})/d_{z}-error_{ref}", 100, -4., 4.);
   hMatch_ptCut_pull_p = fs->make<TH1D>("hMatch_ptCut_pull_p", "GsfTrack_{matched}: (p_{test} - p_{ref})/p_{ref}", 100, -1.1, 1.1);
   hMatch_ptCut_pull_pt = fs->make<TH1D>("hMatch_ptCut_pull_pt", "GsfTrack_{matched}: (p_{T}^{test} - p_{T}^{ref})/p_{T}^{ref}", 100, -1.1, 1.1);
   hMatch_ptCut_pull_eta = fs->make<TH1D>("hMatch_ptCut_pull_eta", "GsfTrack_{matched}: (#eta_{test} -  #eta_{ref})/#eta_{ref}", 100, -0.02, 0.02);
   hMatch_ptCut_pull_ptError = fs->make<TH1D>("hMatch_ptCut_pull_ptError", "GsfTrack_{matched}: (p_{T}-error_{test} - p_{T}-error_{ref})/p_{T}-error_{ref}", 100, -1.1, 1.1);
   hMatch_ptCut_pull_dPtOverPt = fs->make<TH1D>("hMatch_ptCut_pull_dPtOverPt", "GsfTrack_{matched}: (dp_{T}/p_{T}^{test} - dp_{T}/p_{T}^{ref})/(dp_{T}/p_{T}^{ref})", 100, -1.1, 1.1);
   hMatch_ptCut_pull_etaError = fs->make<TH1D>("hMatch_ptCut_pull_etaError", "GsfTrack_{matched}: (#eta-error_{test} - #eta-error_{ref})/#eta-error_{ref}", 100, -1.1, 1.1);
   hMatch_ptCut_pull_phiError = fs->make<TH1D>("hMatch_ptCut_pull_phiError", "GsfTrack_{matched}: (#phi-error_{test} - #phi-error_{ref})/#phi-error_{ref}", 100, -1.1, 1.1);
   hMatch_ptCut_pull_outerP = fs->make<TH1D>("hMatch_ptCut_pull_outerP", "GsfTrack_{matched}: (p_{out}^{test} - p_{out}^{ref})/p_{out}^{ref}", 100, -1.1, 1.1);
   hMatch_ptCut_pull_outerPt = fs->make<TH1D>("hMatch_ptCut_pull_outerPt", "GsfTrack_{matched}: ((p_{T}^{out})_{test} - (p_{T}^{out})_{ref})/(p_{T}^{out})_{ref}", 100, -1.1, 1.1);
   hMatch_ptCut_pull_outerEta = fs->make<TH1D>("hMatch_ptCut_pull_outerEta", "GsfTrack_{matched}: (#eta_{out}^{test} - #eta_{out}^{ref})/#eta_{out}^{ref}", 100, -0.05, 0.05);
   hMatch_ptCut_pull_outerPOverP = fs->make<TH1D>("hMatch_ptCut_pull_outerPOverP", "GsfTrack_{matched}: ((p_{out}/p)_{test} - (p_{out}/p)_{ref})/(p_{out}/p)_{ref}", 100, -1.1, 1.1);
   hMatch_ptCut_pull_outerPtOverPt = fs->make<TH1D>("hMatch_ptCut_pull_outerPtOverPt", "GsfTrack_{matched}: ((p_{T}^{out}/p_{T})_{test} - (p_{T}^{out}/p_{T})_{ref})/(p_{T}^{out}/p_{T})_{ref}", 100, -1.1, 1.1);
   hMatch_ptCut_pull_chi2 = fs->make<TH1D>("hMatch_ptCut_pull_chi2", "GsfTrack_{matched}: (#chi^{2}_{test} - #chi^{2}_{ref})/#chi^{2}_{ref}", 100, -1.1, 1.1);
   hMatch_ptCut_pull_ndof = fs->make<TH1D>("hMatch_ptCut_pull_ndof", "GsfTrack_{matched}: (ndof_{test} - ndof_{ref})/ndof_{ref}", 100, -1.1, 1.1);
   hMatch_ptCut_pull_normalizedChi2 = fs->make<TH1D>("hMatch_ptCut_pull_normalizedChi2", "GsfTrack_{matched}: ((#chi^{2}_{normalized})_{test} - (#chi^{2}_{normalized})_{ref})/(#chi^{2}_{normalized})_{ref}", 100, -1.1, 1.1);
   hMatch_ptCut_pull_dxy = fs->make<TH1D>("hMatch_ptCut_pull_dxy", "GsfTrack_{matched}: (d_{xy}^{test} - d_{xy}^{ref})/d_{xy}^{ref}", 100, -1.1, 1.1);
   hMatch_ptCut_pull_dz = fs->make<TH1D>("hMatch_ptCut_pull_dz", "GsfTrack_{matched}: (d_{z}^{test} - d_{z}^{ref})/d_{z}^{ref}", 100, -1.1, 1.1);
   hMatch_ptCut_pull_dxyError = fs->make<TH1D>("hMatch_ptCut_pull_dxyError", "GsfTrack_{matched}: (d_{xy}-error_{test} - d_{xy}-error_{ref})/d_{xy}-error_{ref}", 100, -1.1, 1.1);
   hMatch_ptCut_pull_dzError = fs->make<TH1D>("hMatch_ptCut_pull_dzError", "GsfTrack_{matched}: (d_{z}-error_{test} - d_{z}-error_{ref})/d_{z}-error_{ref}", 100, -1.1, 1.1);
   hMatch_ptCut_pull_numberOfValidHits = fs->make<TH1D>("hMatch_ptCut_pull_numberOfValidHits", "GsfTrack_{matched}: (#hits_{valid}^{test} - #hits_{valid}^{ref})/#hits_{valid}^{ref}", 40, -1., 3.);
   hMatch_ptCut_pull_numberOfLostHits = fs->make<TH1D>("hMatch_ptCut_pull_numberOfLostHits", "GsfTrack_{matched}: (#hits_{lost}^{test} - #hits_{lost}^{ref})/#hits_{lost}^{ref}", 10, -2.5, 2.5);
   hMatch_ptCut_pull_validFraction = fs->make<TH1D>("hMatch_ptCut_pull_validFraction", "GsfTrack_{matched}: (valid fraction_{test} - valid fraction_{ref})/valid fraction_{ref}", 100, -1., 1.);
   ...
   hR_dEta_dEta = fs->make<TH1D>("hR_dEta_dEta", "GsfTrack-SC: #Delta#eta", 100, 0., 0.05);
   ...
   hR_dEta_dEta_trgdEcalCands = fs->make<TH1D>("hR_dEta_dEta_trgdEcalCands", "GsfTrack-SC: #Delta#eta_{passing recoEcalCands}", 100, 0., 0.01);
   ...
   hR_dPhi_dPhi = fs->make<TH1D>("hR_dPhi_dPhi", "GsfTrack-SC: #Delta#phi", 100, 0., 0.05);
   ...
   hR_dPhi_dPhi_trgdEcalCands = fs->make<TH1D>("hR_dPhi_dPhi_trgdEcalCands", "GsfTrack-SC: #Delta#phi_{passing recoEcalCands}", 100, 0., 0.05);
   ...
   hT_dEta_dEta = fs->make<TH1D>("hT_dEta_dEta", "GsfTrack-SC: #Delta#eta", 100, 0., 0.05);
   ...
   hT_dEta_dEta_trgdEcalCands = fs->make<TH1D>("hT_dEta_dEta_trgdEcalCands", "GsfTrack-SC: #Delta#eta_{passing recoEcalCands}", 100, 0., 0.01);
   ...
   hT_dPhi_dPhi = fs->make<TH1D>("hT_dPhi_dPhi", "GsfTrack-SC: #Delta#phi", 100, 0., 0.05);
   ...
   hT_dPhi_dPhi_trgdEcalCands = fs->make<TH1D>("hT_dPhi_dPhi_trgdEcalCands", "GsfTrack-SC: #Delta#phi_{passing recoEcalCands}", 100, 0., 0.05);
