...
void macro_plotDiffHist()
{
   ...
   if (compToReco) legEntries.push_back("KF");
   ...
   //for (unsigned int i = 0; i < 3; ++i) {
      ...
      if (saveAsPng) {
         if (compToReco) c0->Print(plotsDir + "hDelta_vsReco_" + histoNames[i].Remove(0, 7) + fileNameExtra + ".png", "png");
         else c0->Print(plotsDir + "hDelta_" + histoNames[i].Remove(0, 7) + fileNameExtra + ".png", "png");
      }
      cout << endl;
   }
}
