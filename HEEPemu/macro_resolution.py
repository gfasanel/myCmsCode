...
for key in keyList:
    if key.GetName()[:len(treePrefices[0])] == treePrefices[0]:
       nTrees += 1
...
if len(treePrefices) > 1:
    ...
    statsBoxList[len(statsBoxList)-1].SetX1NDC(statsBoxCoord[0][0])
    statsBoxList[len(statsBoxList)-1].SetY1NDC(statsBoxCoord[0][1])
    statsBoxList[len(statsBoxList)-1].SetX2NDC(statsBoxCoord[0][2])
    statsBoxList[len(statsBoxList)-1].SetY2NDC(statsBoxCoord[0][3])
