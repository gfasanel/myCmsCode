...
#
    def writeExpected(self):
        bin_str = "bin        {:>17} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} \n".format('zp_lfv','zp_lfv','zp_lfv','zp_lfv', 'zp_lfv', 'zp_lfv', 'zp_lfv', 'zp_lfv', 'zp_lfv')
        procName_str = "process        {:>13} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} \n".format('sig', 'ttbar', 'wwpow', 'wzmg', 'zzmg', 'twpow', 'zjetsll', 'wgamma', 'qcd')
        procNum_str = "process        {:>13} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} \n".format(0, 1, 2, 3, 4, 5, 6, 7, 8)
        expYield_str = "rate        {:>16.3f} {:>9.3f} {:>9.3f} {:>9.3f} {:>9.3f} {:>9.3f} {:>9.3f} {:>9.3f} {:>9.3f} \n".format(self.getSigExpEvts(), self.getNEvts('ttbar'), self.getNEvts('wwpow'), self.getNEvts('wzmg'), self.getNEvts('zzmg'), self.getNEvts('twpow'), self.getNEvts('zjetsll'), self.getNEvts('wgamma'), self.getNEvts('qcd'))
        self.outfile.write(bin_str+procName_str+procNum_str+expYield_str+self.divider_str)

    def writeUncert(self):
        self.outfile.write("lumi          lnN   {:>8} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} \n".format(1.026, 1.026, 1.026, 1.026, 1.026, 1.026, 1.026, 1.026, '-'))
        self.outfile.write("bkgXsec       lnN   {:>8} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} \n".format('-', 1.05, self.getWWxsecUnc(), 1.04, 1.03, 1.03, 1.01, 1.5, '-'))
        self.outfile.write("fakeRate      lnN   {:>8} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} \n".format('-', '-', '-', '-', '-', '-', '-', '-', 1.3))
        pdf_unc = self.pdf_unc.Eval(self.mass)
        self.outfile.write("pdf           lnN   {:>8} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} \n".format('-', pdf_unc, pdf_unc, pdf_unc, pdf_unc, pdf_unc, pdf_unc, pdf_unc, '-'))
        self.outfile.write("accXeff       lnN   {:>8} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} \n".format(1.05, 1.05, 1.05, 1.05, 1.05, 1.05, 1.05, 1.05, '-'))
        self.outfile.write("statMC        lnN   {:>8} {:>9.6} {:>9.6} {:>9.6} {:>9.6} {:>9.6} {:>9.6} {:>9.6} {:>9} \n".format('-', self.getStatErr('ttbar'), self.getStatErr('wwpow'), self.getStatErr('wzmg'), self.getStatErr('zzmg'), self.getStatErr('twpow'), self.getStatErr('zjetsll'), self.getStatErr('wgamma'), '-'))
        self.outfile.write("sigRes        shape {:>8} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} \n".format(1, '-', '-', '-', '-', '-', '-', '-', '-'))
        self.outfile.write("eleScale      shape {:>8} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} \n".format('-', 1, 1, 1, 1, 1, 1, 1, '-'))
        self.outfile.write("muScale       shape {:>8} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} \n".format('-', 1, 1, 1, 1, 1, 1, 1, '-'))
        #self.outfile.write("muonRes       shape {:>8} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} \n".format('-', 1, 1, 1, 1, 1, 1, 1, '-'))
        self.outfile.write("muonResSmear  shape {:>8} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} \n".format('-', 1, 1, 1, 1, 1, 1, 1, '-'))
        self.outfile.write("topPtReweight shape {:>8} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} \n".format('-', 1, '-', '-', '-', '-', '-', '-', '-'))
