...
#ifndef emuSelector_h
#define emuSelector_h
...
#ifdef emuSelector_cxx
EmuSelector::EmuSelector(TTree *tree)
{
...
EmuSelector::~EmuSelector()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t EmuSelector::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t EmuSelector::LoadTree(Long64_t entry)
{
...
void EmuSelector::Init(TTree *tree)
{
...
/* void EmuSelector::Show(Long64_t entry) */
/* { */
...
/*    fChain->Show(entry); */
/* } */
Int_t EmuSelector::Cut(Long64_t entry)
{
